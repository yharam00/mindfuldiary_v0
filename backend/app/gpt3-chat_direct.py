...
cred = credentials.Certificate(
    ...
    '/Users/yoonharam/Desktop/24년연구/깃허브 레포 로컬 다운로드/MindfulJournal-master/backend/app/haram-mindfuldiary1-firebase-adminsdk-zm9xb-c4eb736168.json')
app_1 = firebase_admin.initialize_app(cred)
db = firestore.client()
My_OpenAI_key = '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'
